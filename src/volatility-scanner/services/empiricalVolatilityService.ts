...
export class EmpiricalVolatilityService {
   ...
   */
  async calculateEmpiricalVolatility(symbol: string): Promise<HistoricalVolatility> {
   ...
   */
  private async calculatePercentile(symbol: string, currentVol: number): Promise<number> {
   ...
   */
  async getVolatilityTermStructure(symbol: string): Promise<VolatilityTermStructure[]> {
   ...
   */
  async getVolatilityPremium(symbol: string, impliedVol: number): Promise<number> {
