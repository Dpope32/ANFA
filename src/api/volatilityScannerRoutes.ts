...
export class VolatilityScannerRoutes {
  ...
  private setupRoutes(): void {
     ...
     */
    this.router.post('/opportunities', async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const opportunities = await this.scannerService.scanForOpportunities(symbols, config);
     ...
     */
    this.router.post('/flow', async (req: Request, res: Response, next: NextFunction) => {
      try {
     ...
     */
    this.router.post('/market', async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const scan = await this.scannerService.performMarketScan(symbols, scanType);
     ...
     */
    this.router.get('/volatility/:symbol', async (req: Request, res: Response, next: NextFunction) => {
      try {
     ...
     */
    this.router.get('/liquidity/:symbol', async (req: Request, res: Response, next: NextFunction) => {
      try {
        const { symbol } = req.params;
     ...
     */
    this.router.post('/patterns', async (req: Request, res: Response, next: NextFunction) => {
      try {
        const { symbols, patterns = ['squeeze', 'reversal', 'breakout'] } = req.body;
        ...
        for (const symbol of symbols) {
          for (const patternType of patterns) {
            const pattern = await this.patternRecognition.detectPattern(symbol, patternType as any);
     ...
     */
    this.router.get('/options/chain/:symbol', async (req: Request, res: Response, next: NextFunction) => {
      try {
        const { symbol } = req.params;
     ...
     */
    this.router.get('/options/snapshot/:symbol', async (req: Request, res: Response, next: NextFunction) => {
      try {
        const { symbol } = req.params;
        
        const snapshot = await this.polygonOptions.getOptionsSnapshot(symbol);
     ...
     */
    this.router.get('/options/active', async (req: Request, res: Response, next: NextFunction) => {
      try {
     ...
     */
    this.router.post('/imbalances', async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const imbalances = await this.optionsFlow.detectFlowImbalances(symbols);
     ...
     */
    this.router.get('/conditions', async (req: Request, res: Response, next: NextFunction) => {
      try {
...
export function setupVolatilityScannerRoutes(app: any): void {
  ...
  console.log('   GET  /api/scanner/options/snapshot/:symbol - Get options snapshot');
